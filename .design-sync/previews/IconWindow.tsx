...
import { IconWindow } from "substrate-platform-ui";
  ...
  return (
    <Surface>
      <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: "var(--sp-space-sm)" }}>
        <IconWindow size={16} style={{ color: "var(--sp-text)" }} />
        <span style={{ color: "var(--sp-text-muted)", fontSize: 11 }}>16</span>
      </div>
      <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: "var(--sp-space-sm)" }}>
        <IconWindow size={24} style={{ color: "var(--sp-text)" }} />
        <span style={{ color: "var(--sp-text-muted)", fontSize: 11 }}>24</span>
      </div>
      <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: "var(--sp-space-sm)" }}>
        <IconWindow size={32} style={{ color: "var(--sp-text)" }} />
...
export function Accent() {
  return (
    <Surface>
      <IconWindow size={28} style={{ color: "var(--sp-accent)" }} />
    </Surface>
  );
}
